...
/// ownership without putting SQLCipher reads on MainActor. Quote-trail scans
/// and HTML document assembly also run here so the main actor only mounts
/// ready strings into WebKit.
