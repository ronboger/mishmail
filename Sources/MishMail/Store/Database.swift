...
/// An optimistic thread mutation whose Gmail call failed offline (v39).
...
/// A draft the user saved while Gmail was unreachable (v39). Lives in the
...
final class AppDatabase: @unchecked Sendable {
    ...
    static var migrator: DatabaseMigrator {
        ...
        // v32: persisted AI thread summaries for MCP / reading pane.
        // Cascade with the thread so orphans never linger after prune.
        m.registerMigration("v32") { db in
        ...
        // v39: offline queues. Thread edits made without a network land in
